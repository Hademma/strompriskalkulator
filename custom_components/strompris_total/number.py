...
from .const import (
    ...
    OPT_ENOVA_ORE,
    OPT_MVA_PROSENT,
    OPT_KAP_T1_KR, OPT_KAP_T2_KR, OPT_KAP_T3_KR, OPT_KAP_T4_KR, OPT_KAP_T5_KR, OPT_KAP_T6_KR, OPT_KAP_T7_KR,
)
...
NUMBERS: list[StromprisNumberDescription] = [
    ...
    StromprisNumberDescription(
        ...
        StromprisNumberDescription(
        key="kap_t1_kr_mnd",
        name="Kapasitetsledd trinn 1 (0-2 kW)",
        option_key=OPT_KAP_T1_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
    ...
    StromprisNumberDescription(
        key="kap_t2_kr_mnd",
        name="Kapasitetsledd trinn 2 (2-5 kW)",
        option_key=OPT_KAP_T2_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
    ...
    StromprisNumberDescription(
        key="kap_t3_kr_mnd",
        name="Kapasitetsledd trinn 3 (5-10 kW)",
        option_key=OPT_KAP_T3_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
    ...
    StromprisNumberDescription(
        key="kap_t4_kr_mnd",
        name="Kapasitetsledd trinn 4 (10-15 kW)",
        option_key=OPT_KAP_T4_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
    ...
    StromprisNumberDescription(
        key="kap_t5_kr_mnd",
        name="Kapasitetsledd trinn 5 (15-20 kW)",
        option_key=OPT_KAP_T5_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
    ...
    StromprisNumberDescription(
        key="kap_t6_kr_mnd",
        name="Kapasitetsledd trinn 6 (20-25 kW)",
        option_key=OPT_KAP_T6_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
    ...
    StromprisNumberDescription(
        key="kap_t7_kr_mnd",
        name="Kapasitetsledd trinn 7 (25+ kW)",
        option_key=OPT_KAP_T7_KR,
        native_unit_of_measurement="kr/mnd",
        native_min_value=0,
        native_max_value=10000,
        native_step=1,
